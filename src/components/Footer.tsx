    ...
    <footer className="bg-gray-800 text-white">
      <div className="container-custom py-12">
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-3">
              <p className="flex items-start">
                ...
                37 – A Goutam Buddha Path Uliyan Kadma Jamshedpur Jharkhand 831005
              </p>
              <p className="flex items-start">
                <svg className="h-6 w-6 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                +91-7903486761‬, ‪+91-9903975899
              </p>
              <p className="flex items-start">
                <svg className="h-6 w-6 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TRINAYANI ENTERPRISES. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
