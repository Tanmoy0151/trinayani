      ...
      <div className="max-w-md w-full">
        <div className="mb-8 text-center">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-xl border border-gray-700">
            ...
            {countdown > 0 ? (
              <div className="my-4 px-4 py-3 rounded-md bg-gray-700">
                <p className="text-center">Attempting to reconnect in <span className="font-bold text-primary-500">{countdown}</span> seconds</p>
              </div>
            ) : (
              <div className="my-4 px-4 py-3 rounded-md bg-green-900">
                <p className="text-center text-green-300">Attempting to reconnect now...</p>
              </div>
            )}
            ...
            <div className={`transition-all duration-500 ease-in-out ${showContact ? 'opacity-100 max-h-96' : 'opacity-0 max-h-0 overflow-hidden'}`}>
              <div className="my-6 py-4 border-t border-b border-gray-700">
                <h2 className="text-xl font-bold mb-3 text-primary-500">Need immediate assistance?</h2>
                <p className="mb-2">
                  Please contact our development team:
                </p>
                <div className="bg-gray-900 p-3 rounded-md flex items-center mb-4">
                ...
                <div className="bg-gray-900 p-3 rounded-md flex items-center">
                  <svg className="h-6 w-6 mr-2 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
